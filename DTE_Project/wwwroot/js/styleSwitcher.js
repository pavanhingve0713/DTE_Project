...
function addSwitcher()
{
    ...
    <div class="dlab-demo-panel">
        ...
        <a class="dlab-demo-trigger" data-bs-toggle="tooltip" data-placement="right" data-original-title="Check out more demos" href="javascript:void(0)">
        ...
        <div class="dlab-demo-inner">
            ...
            </div><div class="dlab-demo-content">
                <div class="dlab-wrapper row">
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper ">
                                <img src="/images/demo/pic1.jpg" alt="" class="w-100">
                            </div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="1" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!-- <a href="javascript:void(0);" data-theme="1" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 1</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper ">
                                <img src="/images/demo/pic2.jpg" alt="" class="w-100">
                            </div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="2" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!-- <a href="javascript:void(0);" data-theme="2" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 2</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper "><img src="/images/demo/pic3.jpg" alt="" class="w-100"></div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="3" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!--<a href="javascript:void(0);" data-theme="3" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 3</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper "><img src="/images/demo/pic4.jpg" alt="" class="w-100"></div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="4" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!--<a href="javascript:void(0);" data-theme="4" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 4</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper ">
                                <img src="/images/demo/pic5.jpg" alt="" class="w-100">
                            </div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="5" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!--<a href="javascript:void(0);" data-theme="5" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 5</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper "><img src="/images/demo/pic6.jpg" alt="" class="w-100"></div>
                            <div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="6" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!--<a href="javascript:void(0);" data-theme="6" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 6</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper "><img src="/images/demo/pic7.jpg" alt="" class="w-100"></div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="7" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!-- <a href="javascript:void(0);" data-theme="7" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 7</h5>
                    </div><div class="col-xl-3 col-md-6 mb-4">
                        <div class="overlay-bx  dlab-demo-bx">
                            <div class="overlay-wrapper "><img src="/images/demo/pic8.jpg" alt="" class="w-100"></div><div class="overlay-layer">
                                <a href="javascript:void(0);" data-theme="8" class="btn dlab_theme_demo btn-secondary btn-sm me-2">Default</a>
                                <!--<a href="javascript:void(0);" data-theme="8" class="btn dlab_theme_demo_rtl btn-info btn-sm">RTL Version</a>-->
                            </div>
                        </div><h5 class="text-white">Demo 8</h5>
                    </div>
                </div>
            </div><div class="fs-14 pt-3">
                <span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check
                <a href="#" target="_blank" class="text-primary">documentation.</a>
            </div>
        </div>
    </div> `;
